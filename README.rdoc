...
This is a fork from the original http://github.com/settingslogic/settingslogic, that seems abandonned.
We merged some PRs that are pending on the original repo.
